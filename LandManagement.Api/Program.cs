...
builder.Services.AddScoped<IPlotAllocationService, PlotAllocationService>();
builder.Services.AddScoped<IPlotPaymentService, PlotPaymentService>();
builder.Services.AddScoped<ISaleAgreementService, SaleAgreementService>();
