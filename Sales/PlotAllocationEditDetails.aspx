<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PlotAllocationEditDetails.aspx.cs" Inherits="Customers" %>
...
<body>
    <form id="form1" runat="server">
                                ...
                                <div class="col-md-8">
                                    <div class="card">
                                        <div class="card-header">
                                            <div class="card-title">EDIT OFFER LETTER FOR (<asp:Label runat="server" ID="lblClientName"></asp:Label>)</div>
                                        </div>
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <asp:DropDownList ID="drpCategory" runat="server" class="form-control input-solid">
                                                    ...
                                                    <asp:ListItem Value="Installment" Text="Installment"></asp:ListItem>
                                                </asp:DropDownList>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label for="solidInput">Installment Amount</label>
                                                <asp:TextBox class="form-control input-solid" ID="txtInstallment" runat="server" TextMode="Number"></asp:TextBox>
                                            </div>

                                            <div class="form-group">
                                                <label for="solidInput">Installment Period</label>
                                                <asp:TextBox class="form-control input-solid" ID="txtPeriod" runat="server" TextMode="Number"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="card-action">

                                            <asp:Button runat="server" ID="btnSave" class="btn btn-block btn-primary" Text="Update Offer" Font-Bold="true" OnClick="btnSave_Click" />
                                            <br />
        ...
        <br />
        <asp:Label runat="server" ID="lblSiteCode" Visible="false"></asp:Label><br />
    </form>
</body>
