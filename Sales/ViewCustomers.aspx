<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewCustomers.aspx.cs" Inherits="ViewCustomer" %>
                                    ...
                                    <ul class="nav">
                                        ...
                                        <li>
                                            <a href=" OfferLetterDocuments.aspx">
                                                <span class="link-collapse">Plot Withdrawal</span>
                                            </a>
                                        </li>
                                        <li>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <table id="customersTable" class="table table-striped table-striped-bg-default mt-3">
                                                <thead>
                                                    <tr>
                                                        <th>NAME</th>
                                                        <th>ADDRESS</th>
