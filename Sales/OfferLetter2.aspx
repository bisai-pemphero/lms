    ...
    <div class="a4-container">
        ...
        <table class="modern-table">
            ...
            <tr>
                ...
                <td>:
                    <asp:Label runat="server" ID="lblAdress">123 Main Street, Lusaka, Zambia</asp:Label></td>
            </tr>
            <tr>
                <td class="info-label">Email</td>
                <td>:
                    <asp:Label runat="server" ID="lblEmail">123 Main Street, Lusaka, Zambia</asp:Label></td>
            </tr>
            <tr>
                <td class="info-label">Contact Number</td>
                <td>:
                    <asp:Label runat="server" ID="lblPhone">+260 97 123 4567</asp:Label>
        ...
        <table class="modern-table">
            ...
            <tr>
                ...
                <td>:
                    <asp:Label runat="server" ID="lblSite">Lusaka South</asp:Label></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>:
                    <asp:Label runat="server" ID="lblAgreedPrice">ZMW 250,000</asp:Label></td>
            </tr>
            <tr>
     ...
     <ul>
        ...
        <div class="signature-area">
            ...
            <div class="signature-label">CHIEF EXECUTIVE OFFICER (ON BEHALF OF
                <asp:Label runat="server" ID="lblLandowner"></asp:Label>)</div>
        </div>
