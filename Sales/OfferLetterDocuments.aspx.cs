...
public partial class ViewSite : System.Web.UI.Page
{
    ...
    { 
        ...
        while (dr3.Read())
        {
            lblOwner.Text = dr3.IsDBNull(0) ? string.Empty : dr3.GetString(0);
        }
    ...
    public void LoadPlots()
    {
        ...
        if (generalReport.Rows.Count > 0)
        {
            ...
            foreach (DataRow row in generalReport.Rows)
            {
                ...
                sb.Append("<td>");
                sb.Append("<a class='btn btn-block btn-secondary btn-sm' href='"
                ...
                sb.Append("<td>");
                sb.Append("<a href='PlotWithdrawal.aspx?id=" + plotNo + "' class='btn btn-block btn-primary btn-sm'> Withdraw Offer</a>");
                sb.Append("</td>");
                sb.Append("</tr>");
            }
