<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditPlotprice.aspx.cs" Inherits="Plots" %>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <asp:TextBox class="form-control input-solid" placeholder="Plot Size" ID="txtPlotNumber" runat="server" CssClass="form-control" Enabled="false"></asp:TextBox>
                                            </div>
                                            <div class="form-group">
                                                <label for="solidInput">Plot Size</label>
                                                <asp:TextBox class="form-control input-solid" placeholder="Plot Size" ID="txtSize" runat="server" CssClass="form-control" Enabled="false"></asp:TextBox>
                                            </div>
                                            <div class="form-group">
                                                <label for="solidInput">Plot Price</label>
                                                <asp:TextBox class="form-control input-solid" placeholder="Plot Size" ID="txtPrice" runat="server" CssClass="form-control" TextMode="Number"></asp:TextBox>
                                            </div>
                ...
                <div class="modal fade" id="UpdateModal" tabindex="-1" role="dialog" aria-labelledby="UpdateLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <!-- Body -->
                            <div class="modal-body text-center" style="font-size: 16px; color: #555;">
                                Plot Price Updated Successfully!
                            </div>
                            <!-- Footer -->
                            <div class="modal-footer border-0 d-flex justify-content-center">
