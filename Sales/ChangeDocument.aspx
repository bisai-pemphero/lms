<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ChangeDocument.aspx.cs" Inherits="ViewSite" %>
             ...
             <li class="nav-item dropdown">
                 <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#" aria-expanded="false">
                     <img src="../assets/img/user.png" alt="user-img" width="36" class="img-circle"/><span>
                         <asp:Label runat="server" ID="lblUser" Visible="true"></asp:Label>
                     </span></span> </a>
                                ...
                                <div class="col-md-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <div class="card-title">CHANGE OF OWNERSHIP DOCUMENTS</div>
                                        </div>
