<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddNextofKin.aspx.cs" Inherits="Customers" %>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <asp:TextBox class="form-control input-solid" placeholder="Next of Kin's Fullname" ID="txtFullname" runat="server"></asp:TextBox>
                                            </div>

                                            <div class="form-group">
                                                <label for="solidInput">Relationship</label>
                                                <asp:TextBox class="form-control input-solid" placeholder="Relationship with Client" ID="txtRelationship" runat="server"></asp:TextBox>
                                            </div>


                                            <div class="form-group">
                                                <label for="solidInput">Contact</label>
                                                <asp:TextBox class="form-control input-solid" placeholder="Next of Kin Contact" ID="txtPrimaryContact" runat="server"></asp:TextBox>
