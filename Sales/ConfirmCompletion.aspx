<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ConfirmCompletion.aspx.cs" Inherits="Customers" %>
                 ...
                 <div class="info">
                     ...
                     <div class="collapse in" id="documents" aria-expanded="true" style="">
                         <ul class="nav">
                             ...
                             <li>
                                 <a href="CompletionLetterDocument.aspx">
                                     <span class="link-collapse">Completion Letter</span>
                                 </a>
                             </li>
                         </ul>
                     </div>
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="card">
                                          <div class="card-header">
                                                <div class="card-title">COMPLETION LETTER</div>
                                        </div>
                                        <div class="card-body">

                                            <asp:Button runat="server" ID="btnSave" class="btn btn-block btn-primary" Text="Print" Font-Bold="true" OnClick="btnSave_Click" />
                                            <asp:Label runat="server" ID="lblSession" Visible="false"></asp:Label>
                                         
                                            <asp:Label runat="server" ID="lblPlotNo" Visible="false"></asp:Label> <br />
                                            <asp:Label runat="server" ID="lblSiteNo" Visible="false"></asp:Label><br />
