<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OfferLetter2.aspx.cs" EnableEventValidation="false" Inherits="OfferLetter" %>
    ...
    <div class="a4-container">
      ...
      <td>: <asp:Label runat="server" ID="lblEmail">123 Main Street, Lusaka, Zambia</asp:Label></td>
        ...
        <div class="conditions">
            ...
            <ol>
                <li>The Sale is strictly based on&nbsp; an as is basis as per the demarcarted site layout.</li>
                <li>The buyer understands that Innobuild has been appointed as the realtor to manage and sell the demarcated plots.</li>
                <li>The buyer shall make payment directly to the landowner’s account as provided below:  
                    <br />
                    <strong>Account Name:   </strong>  <asp:Label runat="server" ID="lblAccountName"></asp:Label>
                  
                    <br />
                    <strong>Bank         :     </strong>   <asp:Label runat="server" ID="lblBankName"></asp:Label>
                    
                    <br />
                    <strong>Account Number:  </strong>  <asp:Label runat="server" ID="lblAccountNumber"></asp:Label>
                   
                    <br />
                    <strong>Branch     :   </strong>     <asp:Label runat="server" ID="lblBranchName"></asp:Label>
                    
                </li>
                <li>The initial payment (not less than 35% of the offer price) must be made within the offer validity period to confirm acceptance of this offer.</li>
                <li>Upon full payment and signing of the Sales Agreement, the buyer shall be eligible to commence development on the plot. </li>
                <li>Failure to make payment within the given period will lead to automatic cancellation of the offer, and the plot will be reallocated to another buyer. </li>
                <li>All deposits made shall be supported with an electronic receipt issued by Innobuild Limited upon presentation of the official bank deposit slip.</li>
             <li>Any delay in monthly payments shall attract the following penalties:
     <ul>
         ...
         <li>Monthly payments between K200,000 and K500,000 shall incur a penalty of K60,000.</li>
            ...
            <p><strong>Note:</strong> All payments are strictly to be made to the landowner’s account listed above. Innobuild Limited only serves as the appointed realtor managing the sales, marketing, and allocation of plots on behalf of the Landowner.</p>
        </div>
        ...
        <div class="signature-area">
            ...
            <div class="signature-label">CHIEF EXECUTIVE OFFICER (ON BEHALF OF <asp:Label runat="server" ID="lblLandowner"></asp:Label>)</div>
        </div>
        ...
        <div class="action-buttons">
            ...
            <a href="OfferLetterDocuments.aspx" type="button" class="action-button back-button">Back to Home</a>
