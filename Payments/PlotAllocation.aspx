<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PlotAllocation.aspx.cs" Inherits="Customers" %>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <asp:TextBox class="form-control input-solid" placeholder="Type client's name to search offer" ID="txtSearch" runat="server" CssClass="form-control" AutoPostBack="true" OnTextChanged="txtSearch_TextChanged"></asp:TextBox>
                                            </div>
                                            <div class="form-group">
                                                <label for="solidInput">Select Action</label>
                                                <asp:DropDownList ID="drpUpsert" runat="server" class="form-control input-solid" AutoPostBack="true" OnSelectedIndexChanged="drpUpsert_SelectedIndexChanged">
                                                </asp:DropDownList>
                                            </div>

                                            <div class="form-group">
                                                <label for="solidInput">Select Site</label>
                                                <asp:DropDownList ID="drpSite" runat="server" AutoPostBack="True" CssClass="form-control input-solid" OnSelectedIndexChanged="drpSite_SelectedIndexChanged">
                                                </asp:DropDownList>

                                            </div>
                                            <div class="form-group">
                                                <label for="solidInput">Select Plot</label>
                                                <asp:DropDownList ID="drpPlot" runat="server" class="form-control input-solid">
                                                </asp:DropDownList>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <asp:DropDownList ID="drpCategory" runat="server" class="form-control input-solid" AutoPostBack="true" OnSelectedIndexChanged="drpCategory_SelectedIndexChanged">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <asp:TextBox CssClass="form-control input-solid" placeholder="Plot Size" ID="txtSize" ForeColor="Black" Font-Bold="true" runat="server" Enabled="false"></asp:TextBox>
                                            </div>

                                            <div class="form-group">
                                                <label for="solidInput">Selling Price</label>
                                                <asp:TextBox CssClass="form-control input-solid" placeholder="Selling Price" ID="txtSellingPrice" ForeColor="Black" Font-Bold="true" runat="server" Enabled="false"></asp:TextBox>
                                            ...
                                            <div class="form-group">
                                                <label for="solidInput">Commitment Period (Days)</label>
                                                <asp:TextBox class="form-control input-solid" placeholder="Number of days before initial payment" ID="txtCommitmentPeriod" runat="server" TextMode="Number"></asp:TextBox>
                                            </div>

                                            <div class="form-group">
                                                <label for="solidInput">Contract Duration (Month)</label>
                                                <asp:TextBox class="form-control input-solid" placeholder="Contract Duration" ID="txtContractDuration" runat="server"></asp:TextBox>
                                            </div>

                                            <div class="form-group">
                                                <label for="solidInput">Client</label>
                                                <asp:DropDownList ID="drpClient" runat="server" class="form-control input-solid">
                                                </asp:DropDownList>
                                            </div>
                                        ...
                                        <div class="card-action">
                                            ...
                                            <asp:Button runat="server" ID="btnSave" class="btn btn-primary" Text="Save" Font-Bold="true" OnClick="btnSave_Click" />
                                            <asp:Button runat="server" ID="btnUpdate" class="btn btn-success" Text="Update" Font-Bold="true" OnClick="btnUpdate_Click" />
                                            <asp:Button runat="server" ID="btnDelete" class="btn btn-danger" Text="Withdraw Plot" Font-Bold="true" OnClick="btnDelete_Click" />
                                            ...
                                            <asp:Label runat="server" ID="lblPhoneNumber2" Visible="false"></asp:Label>
                                        </div>
                                    </div>
                                </div>
                            </div>
