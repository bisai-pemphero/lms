<%@ Page Language="C#" AutoEventWireup="true" Async="true" CodeFile="CreditorVoucherEdit.aspx.cs" Inherits="Customers" %>
...
<body>
    <form id="form1" runat="server">
      ...
      <asp:TextBox class="form-control input-solid" placeholder="Fullname" ID="txtFullname" runat="server"></asp:TextBox>
  </div>

<div class="form-group">
      <label for="solidInput">Amount</label>
      <asp:TextBox class="form-control input-solid" ID="txtAmount" runat="server" TextMode="Number"></asp:TextBox>
  </div>

  <div class="form-group">
      <label for="solidInput">Amount in Words</label>
      <asp:TextBox class="form-control input-solid" placeholder="Amount in Words" ID="txtinWords" runat="server"></asp:TextBox>
  </div>

  <div class="form-group">
      <label for="solidInput">PaymentMode</label>
      <asp:DropDownList ID="drpPaymentMode" runat="server" class="form-control input-solid">
  ...
  <div class="form-group">
      ...
      <asp:TextBox class="form-control input-solid" placeholder="Cheque No" ID="txtChequeNo" runat="server"></asp:TextBox>
  </div>
  <div class="form-group">
      <label for="solidInput">BankName </label>
      <asp:TextBox class="form-control input-solid" placeholder="Bank Name" ID="txtBank" runat="server"></asp:TextBox>
  </div>

  <div class="form-group">
      <label for="solidInput">Account No </label>
      <asp:TextBox class="form-control input-solid" placeholder="Account No" ID="txtAccountNo" runat="server"></asp:TextBox>
  </div>

  <div class="form-group">
      <label for="solidInput">Description </label>
      <asp:TextBox class="form-control input-solid" placeholder="Payment Description" ID="txtDescription" runat="server" TextMode="MultiLine"></asp:TextBox>
  </div>

  <div class="form-group">
      <label for="solidInput">Reference </label>
      <asp:TextBox class="form-control input-solid" placeholder="Payment Reference" ID="txtReference" runat="server"></asp:TextBox>
  </div>


                                        </div>
                                        <div class="card-action">
                                            <asp:Button runat="server" ID="btnSave" class="btn btn-block btn-primary" Text="Update Voucher" Font-Bold="true" OnClick="btnSave_Click" />
                                             <asp:Button runat="server" ID="btnBack" class="btn btn-block btn-secondary" Text="Exit" Font-Bold="true" OnClick="btnExit_Click" Visible="false" />
                            ...
                            <div class="col-md-2">
                                ...
                                <asp:Label runat="server" ID="lblVoucherNo" Visible="false"></asp:Label>
                                   ...
                                   <asp:Label runat="server" ID="lblInitialValue" Visible="false"></asp:Label>
                                    <asp:Label runat="server" ID="lblPaid" Visible="false"></asp:Label>
                                     <asp:Label runat="server" ID="lblSiteCode" Visible="false"></asp:Label>

                                 <asp:Label runat="server" ID="lblPrevious" Visible="false"></asp:Label>
