<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditPayment.aspx.cs" Inherits="Customers" %>
                                ...
                                <div class="col-md-8">
                                    <div class="card">
                                        <div class="card-header">
                                            <div class="card-title">PLOT PAYMENT FOR 
                                                <asp:Label runat="server" ID="lblFor"></asp:Label></div>
                                        </div>
                                        <div class="card-body">
                                            ...
                                            <label for="solidInput">Amount Paying</label>
                                    ...
                                    <div class="card-action">
                                        <asp:Button runat="server" ID="btnUpdate" class="btn btn-block btn-primary" Text="Update Receipt" Font-Bold="true" OnClick="btnUpdate_Click" />
                                        <asp:Button runat="server" ID="btnDelete" class="btn btn-block btn-danger" Text="Delete Receipt" Font-Bold="true" OnClick="btnDelete_Click" />
                                    </div>
                                </div>
                            </div>
                        </div>
