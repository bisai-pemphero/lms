                    ...
                    <div class="user">
                        <div class="info">
                            ...
                            <div class="collapse in" id="reminders" aria-expanded="true" style="">
                                <ul class="nav">
                                    <li>
                                        <a href="Reminder.aspx">
                                            <span class="link-collapse">Send Reminder</span>
                                        </a>
                                    </li>
                    ...
                    <div class="container-fluid">
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-md-8">
                                            <h5 style="color: #2c3e50; font-weight: 600; margin-bottom: 10px;">
                                                <i class="la la-bell"></i>Send Monthly Reminders
                                            </h5>
                                            <p class="text-muted mb-0">Send SMS reminders to customers who haven't made their monthly payment.</p>
                                        </div>
                                        <div class="col-md-4 text-md-right mt-3 mt-md-0">
                                            <asp:Button runat="server" ID="btnSend" class="btn-send-reminder" Text="Send Reminders" Font-Bold="true" OnClick="btnSend_Click" OnClientClick="showLoading();" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="action-card">
                                    <div class="row align-items-center">
                                        <div class="col-md-8">
                                            <h5 style="color: #2c3e50; font-weight: 600; margin-bottom: 10px;">
                                                <i class="la la-check-circle"></i> Send Monthly Penalties
                                            </h5>
                                            <p class="text-muted mb-0">Send SMS Charges to customers who haven't made their monthly payment. This action can only be performed once per month.</p>
                                        </div>
                                        <div class="col-md-4 text-md-right mt-3 mt-md-0">
                                            <asp:Button runat="server" ID="btnPenalties" class="btn-send-penalty" Text="Send Penalties" Font-Bold="true" OnClick="btnPenalties_Click" OnClientClick="showLoading();" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="action-card">
                                    <div class="row align-items-center">
                                        <asp:Label runat="server" ID="lblError" Style="font-size: large; color: #FF3300"></asp:Label>
