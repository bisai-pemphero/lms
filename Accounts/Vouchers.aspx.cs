...
public partial class ViewCustomer : System.Web.UI.Page
{
    ...
    public void LoadCustomerDetails()
    {
        ...
        using (SqlConnection connection = new SqlConnection(connectionString))
        {
            ...
            SqlCommand command = new SqlCommand(@"Select [PaymentVoucherID], 
            [PayeeName], [Description], [Amount], [Status] FROM [PaymentVoucher]", connection);
            ...
            while (reader.Read())
            {
                ...
                Response.Write("<td>");
                Response.Write("<a href='VoucherPayment.aspx?id=" + Id + "' class='btn btn-primary btn-sm'> Edit</a>");
                Response.Write("</td>");

                Response.Write("<td>");
                if (status.Equals("Paid", StringComparison.OrdinalIgnoreCase))
                {
                    Response.Write("<a href='VoucherPrint.aspx?id=" + Id + "' class='btn btn-secondary btn-sm'>Print</a>");
                }
                Response.Write("</td>");
