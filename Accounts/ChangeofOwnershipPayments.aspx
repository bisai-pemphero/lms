<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ChangeofOwnershipPayments.aspx.cs" Inherits="Customers" %>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <asp:TextBox CssClass="form-control input-solid" placeholder="Site Name" ID="txtSite" runat="server" Enabled="false"></asp:TextBox>
                                            </div>
                                            <div class="form-group">
