<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PlotRegistration.aspx.cs" Inherits="Plots" %>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <asp:TextBox class="form-control input-solid" placeholder="Plot Size" ID="txtPlotNumber" runat="server" CssClass="form-control"></asp:TextBox>
                                            </div>
                                            <div class="form-group">
                                                <label for="solidInput">Plot Size</label>
                                                <asp:TextBox class="form-control input-solid" placeholder="Plot Size" ID="txtSize" runat="server" CssClass="form-control" TextMode="Number"></asp:TextBox>
                                            </div>
                                        ...
                                        <div class="card-action">
                                            ...
                                            <asp:Label runat="server" ID="lblPricePerSquareMeter" Visible="false"></asp:Label>
