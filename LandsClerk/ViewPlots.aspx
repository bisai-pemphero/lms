                    ...
                    <div class="content">
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <table id="siteTables" class="table table-striped table-striped-bg-default mt-3">
                                                <thead>
                                                    <tr>
                                                        <th>NAME</th>
                                                        <th>ALLOCATED</th>
                              ...
                              <asp:Label runat="server" ID="lblRemainingAcreage" Visible="false"></asp:Label>
                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <asp:TextBox class="form-control input-solid" placeholder="Plot Number" ID="txtPlotMark" runat="server"></asp:TextBox>
                                </div>

                                <div class="form-group">
                                    <label for="solidInput">Plot Size</label>
                                    <asp:TextBox class="form-control input-solid" placeholder="Plot Size" ID="txtSize" runat="server" TextMode="Number" AutoPostBack="true"></asp:TextBox>
                                </div>
                                ...
                                <asp:TextBox class="form-control input-solid" ID="txtSellingPrice" runat="server" CssClass="form-control" TextMode="Number" Visible="false"></asp:TextBox>
                            </div>
