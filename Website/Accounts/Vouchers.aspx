<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Vouchers.aspx.cs" Inherits="ViewCustomer" %>
...
<body>
                                        ...
                                        <div class="row">
                                            <div class="col-md-10">
                                                <div class="card-header">
                                                    <div class="card-title">VOUCHERS</div>
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="form-group">
    ...
    <asp:TextBox ID="txtAmount"
        runat="server"
        CssClass="form-control input-solid"
        TextMode="Number"></asp:TextBox>
</div>

<div class="form-group">
    <label>Amount in Words</label>
    <asp:TextBox ID="txtinWords"
        runat="server"
        CssClass="form-control input-solid"
        ReadOnly="true"></asp:TextBox>

    <asp:HiddenField ID="hfInWords" runat="server" />
</div>
...
<script type="text/javascript">
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        var txtAmount = document.getElementById("<%= txtAmount.ClientID %>");
                var txtInWords = document.getElementById("<%= txtinWords.ClientID %>");
                var hfInWords = document.getElementById("<%= hfInWords.ClientID %>");

                txtAmount.addEventListener("input", function () {
                    ...
                    var words = numberToWords(amount) + " Malawi Kwacha Only";

                    txtInWords.value = words;
                    hfInWords.value = words;
                });
