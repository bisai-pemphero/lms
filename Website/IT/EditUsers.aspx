<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditUsers.aspx.cs" Inherits="Plots" %>
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                        ...
                                        <div class="card-body">
                                             ...
                                             <div class="form-group row">
                                                ...
                                                <div class="col-sm-12">
                                                    <p class="form-control-static">
                                                        <asp:TextBox class="form-control" placeholder="Full Name" ID="txtname" runat="server"></asp:TextBox>
                                                    </p>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-12">
                                                    ...
                                                    <p class="form-control-static">
                                                        <asp:TextBox class="form-control" placeholder="Email" ID="txtusername" runat="server"></asp:TextBox>
                                                    </p>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-12">
                                                    ...
                                                    <p class="form-control-static">
                                                        <asp:TextBox class="form-control" placeholder="Password" ID="txtpassword" TextMode="Password" runat="server"></asp:TextBox>
                                                    </p>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-12">
                                                    ...
                                                    <p class="form-control-static">
                                                        <asp:DropDownList class="form-control" ID="drpLocation" runat="server">
                                                        </asp:DropDownList>
                                                    </p>
                                                </div>
                                            </div>
                                ...
                                <asp:Label runat="server" ID="lblUserId" Visible="false"></asp:Label>
                                             ...
                                             <asp:Label runat="server" ID="lblLoginEmail" Visible="false"></asp:Label>
