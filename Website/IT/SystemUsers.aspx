                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <table id="systemUsersTable" class="table table-striped table-striped-bg-default mt-3">
                                                <thead>
                                                    <tr>
                                                        <th>USERNAME</th>
                                                        <th>FULL NAME</th>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <p class="form-control-static">
                                           Name:  <asp:TextBox class="form-control" placeholder="Full Name" ID="txtname" runat="server"></asp:TextBox>
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <p class="form-control-static">
                                           Email: <asp:TextBox class="form-control" placeholder="Email" ID="txtusername" runat="server"></asp:TextBox>
                                        </p>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <p class="form-control-static">
                                           Password:  <asp:TextBox class="form-control" placeholder="Password" ID="txtpassword" TextMode="Password" runat="server"></asp:TextBox>
                                        </p>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <p class="form-control-static">
                                           Location : <asp:DropDownList class="form-control" ID="drpLocation" runat="server">
                                            </asp:DropDownList>
                                        </p>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <p class="form-control-static">
                                           Role : <asp:DropDownList class="form-control" ID="drpType" runat="server">
                                            </asp:DropDownList>
                                        </p>
                                    </div>
                                </div>
