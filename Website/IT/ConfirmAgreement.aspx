<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ConfirmAgreement.aspx.cs" Inherits="Customers" %>
...
<body>
  ...
  <div class="user">
      ...
      <div class="card-title">SALES AGREEMENT</div>
  </div>
                                        <div class="card-body">

                                            <asp:Button runat="server" ID="btnSave" class="btn btn-block btn-primary" Text="PRODUCE SALES AGREEMENT" Font-Bold="true" OnClick="btnSave_Click" />
