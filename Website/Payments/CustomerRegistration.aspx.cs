...
public partial class Customers : System.Web.UI.Page
{
    ...
    public void LoadCustomers()
    {
        ...
        string sql = @"  Select C.ID, C.Fullname from Clients as C Join Users as U
    ...
    public void LoadClientCode()
    {
        ...
        while (dr.Read())
        {
            lblClientCode.Text = "CC0" + dr.GetInt32(0).ToString();
        }
    ...
    protected void drpUpsert_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            string[] client = drpUpsert.Text.Split('|');
            int clientId = Convert.ToInt32(client[0]);  

            //display details
            string sql1 = @"Select [Fullname], [District], [Address], [PhoneNo], [PhoneNo2], 
            [Email], [Occupation], [IdentityNo]	from Clients where ID = @Id";
   ...
   public void Reset()
    ...
    protected void btnUpdate_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string[] customer = drpUpsert.Text.Split('|');
            int customerId = Convert.ToInt32(customer[0]);
            ...
            string sql = @"Update Clients set Fullname = @fullname, District =  @district, Address =  @address,
                    ...
                    Occupation = @occupation, IdentityNo = @identity";
            SqlCommand cmd = new SqlCommand(sql, appconSQL2);
            cmd.Parameters.AddWithValue("@fullname", txtFullname.Text.Trim());
            cmd.Parameters.AddWithValue("@district", drpDistrict.Text.Trim());
            cmd.Parameters.AddWithValue("@address", txtAddress.Text.Trim());
