<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CustomerRegistration.aspx.cs" Inherits="Customers" %>
                                ...
                                <div class="col-md-8">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <label for="solidInput">Customers Fullname</label>
                                                <asp:TextBox class="form-control input-solid" placeholder="Customers Fullname" ID="txtFullname" runat="server"></asp:TextBox>
                                            </div>

                                            <div class="form-group">
                                                <label for="solidInput">Contact Address</label>
                                                <asp:TextBox class="form-control input-solid" placeholder="Contact Address" ID="txtAddress" runat="server" TextMode="MultiLine"></asp:TextBox>
                                            </div>

                                            <div class="form-group">
                                                <label for="solidInput">Primary Contact Number</label>
                                                <asp:TextBox class="form-control input-solid" placeholder="Contact 1" ID="txtPrimaryContact" runat="server"></asp:TextBox>
                                            </div>

                                            <div class="form-group">
                                                <label for="solidInput">Secondary Contact Number</label>
                                                <asp:TextBox class="form-control input-solid" placeholder="Contact 2" ID="txtPhoneNumber2" runat="server"></asp:TextBox>
                                            </div>

                                            <div class="form-group">
                                                <label for="solidInput">Email</label>
                                                <asp:TextBox class="form-control input-solid" placeholder="Customers Email" ID="txtEmail" runat="server"></asp:TextBox>

                                            </div>

                                            <div class="form-group">
                                                <label for="solidInput">Occupation</label>
                                                <asp:TextBox class="form-control input-solid" placeholder="Customers Occupation" ID="txtOccupation" runat="server"></asp:TextBox>
                                            </div>
                                            <div class="form-group">
                                                <label for="solidInput">National ID</label>
                                                <asp:TextBox class="form-control input-solid" placeholder="National ID if Available" ID="txtNationalId" runat="server"></asp:TextBox>
                                            </div>
                                            <div class="form-group">
                                                <label for="solidInput">Home District</label>
                                        ...
                                        <div class="card-action">
                                            ...
                                            <asp:Button runat="server" ID="btnDelete" class="btn btn-danger" Text="Delete" Font-Bold="true" OnClick="btnDelete_Click" />
