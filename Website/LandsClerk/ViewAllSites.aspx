                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="form-group">
                            ...
                            <asp:TextBox class="form-control input-solid" placeholder="Square Meters" ID="txtNewLandSite" runat="server" TextMode="Number" CssClass="form-control"></asp:TextBox>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <asp:TextBox class="form-control input-solid" placeholder="Beacons, Grader costs" ID="txtNewDevDone" runat="server" CssClass="form-control"></asp:TextBox>
