                                    ...
                                    <ul class="nav">
                                        ...
                                        <li>
                                            <a href="ViewAllSites.aspx">
                                                <span class="link-collapse">Site Details</span>
                                            </a>
                                        </li>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <asp:TextBox class="form-control input-solid" placeholder="Description" ID="txtDescription" runat="server" CssClass="form-control"></asp:TextBox>
                                            </div>

                                            <div class="form-group">
                                                <label for="solidInput">Site Size</label>
                                                <asp:TextBox class="form-control input-solid" placeholder="Square Meters" ID="txtSize" runat="server" TextMode="Number" CssClass="form-control"></asp:TextBox>
                                            </div>

                                            <div class="form-group">
                                                <label for="solidInput">Road Size</label>
                                                <asp:TextBox class="form-control input-solid" placeholder="Road Size" ID="txtRoadSize" runat="server" TextMode="Number" CssClass="form-control"></asp:TextBox>
                                            </div>
                                            <div class="form-group">
                                                <label for="solidInput">Total Plot Acreage</label>
                                                <asp:TextBox class="form-control input-solid" placeholder="Square Meters" ID="txtPlotAcreage" runat="server" TextMode="Number" CssClass="form-control"></asp:TextBox>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <asp:TextBox class="form-control input-solid" placeholder="Beacons, Grader costs" ID="txtDevelopment" runat="server" CssClass="form-control"></asp:TextBox>
                                            ...
                                            <div class="form-group">
                                                <label for="solidInput">Sketch Map</label>
                                                <asp:FileUpload runat="server" ID="fnSketchmap" CssClass="form-control" />
                                            </div>
                                        </div>
                                        <div class="card-action">


                                            <asp:Button runat="server" ID="btnUpdate" class="btn btn-success" Text="Update All" Font-Bold="true" OnClick="btnUpdate_Click" />

                                            <asp:Button runat="server" ID="btnUpdateSketch" class="btn btn-secondary" Text="Update Sketch Map" Font-Bold="true" OnClick="btnUpdateSketch_Click" />
                                            <asp:Button runat="server" ID="btnDelete" class="btn btn-danger" Text="Back" Font-Bold="true" OnClick="btnDelete_Click" />
                                            ...
                                            <asp:Label runat="server" ID="lblUser" Visible="false"></asp:Label>
                                             ...
                                             <asp:Label runat="server" ID="lblSketch" Visible="false"></asp:Label>
