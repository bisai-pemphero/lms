...
<head runat="server">
    ...
    <style>
        /* Force the profile icon to remain visible on mobile layouts */
        @media (max-width: 991px) {
            .navbar-header .navbar-nav.topbar-nav {
        ...
        <div>
            <div class="wrapper">
                            ...
                            <ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-user">
                                        <li><a class="dropdown-item" href="../UserLogin.aspx"><i class="la la-power-off"></i>Logout</a></li>
                                        <li><a class="dropdown-item" href="ChangePassword.aspx"><i class="la la-gears"></i>Change Password</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="main-panel">
                    <div class="content">
                        <div class="container-fluid">
                            <h4 class="page-title">Lands Clerk Dashboard</h4>
                            <div class="row">
                                <div class="col-md-3">
