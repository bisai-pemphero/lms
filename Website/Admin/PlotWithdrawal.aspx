<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PlotWithdrawal.aspx.cs" Inherits="Plotwithdrawal" %>
         ...
         <div class="collapse in" id="settings" aria-expanded="true" style="">
             <ul class="nav">
                ...
                <div class="main-panel">
                                ...
                                <div class="col-md-10">
                                    <div class="card">
                                        <div class="card-header">
                                            <div class="card-title">WITHDRAW PLOT FROM - <asp:Label runat="server" ID="lblClientName"></asp:Label> (<asp:Label runat="server" ID="lblSiteName"></asp:Label>) </div>
                                        </div>
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <label for="solidInput">
                                                            <asp:Label runat="server" ID="lblPaid" Style="font-size: large; color: black"></asp:Label></label>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label for="solidInput">Reason for Withdrawal</label>
                                                <asp:TextBox runat="server" CssClass="form-control input-solid" ID="txtWithdrawal" Enabled="false"></asp:TextBox>
                                            </div>
                                            <div class="form-group">
                                                <label for="solidInput">Refund Amount</label>
                                                <asp:TextBox runat="server" CssClass="form-control input-solid" ID="txtRefundAmount" TextMode="Number" Enabled="false"></asp:TextBox>
                                            </div>
                                            <div class="card-action">

                                                <asp:Button runat="server" ID="btnSave" class="btn btn-primary" Text="Approve Withdrawal" Font-Bold="true" OnClick="btnSave_Click" />

                                                   <asp:Button runat="server" ID="btnDecline" class="btn btn-warning" Text="Reject Withdrawal" Font-Bold="true" OnClick="btnDecline_Click" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="modal fade" id="RejectModal" tabindex="-1" role="dialog" aria-labelledby="successLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <!-- Header with Icon -->
                <div class="modal-header border-0 d-flex flex-column align-items-center">

                    <h4 class="modal-title mt-2" style="font-size: 24px; color: steelblue;" id="rejectLabel"></h4>
                    <br />
                    <hr />
                    <i class="la la-check-circle" style="font-size: 60px; color: #2170b9;"></i>
                </div>
                <!-- Body -->
                <div class="modal-body text-center" style="font-size: 16px; color: #555;">
                   Plot Withdrawal Rejected Successfully!
                </div>
                <!-- Footer -->
                <div class="modal-footer border-0 d-flex justify-content-center">
