                                ...
                                <div class="col-md-10">
                                    <div class="card">
                                        <div class="card-header">
                                            <div class="card-title">WITHDRAW PLOT FROM (<asp:Label runat="server" ID="lblClientName"></asp:Label>)</div>
                                        </div>
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <asp:TextBox runat="server" CssClass="form-control input-solid" ID="txtWithdrawal"></asp:TextBox>
                                            </div>
                                            <div class="form-group">
                                                <label for="solidInput">Refund Amount</label>
                                                <asp:TextBox runat="server" CssClass="form-control input-solid" ID="txtRefundAmount" TextMode="Number"></asp:TextBox>
                                            </div>
