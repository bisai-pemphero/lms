<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PlotAllocation.aspx.cs" Inherits="ViewSite" %>
                                ...
                                <div class="col-md-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <div class="row">
                                                <div class="col-md-10">
                                                    <div class="card-title">SELECT SITE</div>
                                                </div>
                                                <div class="col-md-2">
                                                    <asp:Button runat="server" ID="btnEdit" class="btn btn-block btn-secondary" Text="Edit Offer Letter" Font-Bold="true" OnClick="btnEdit_Click" />
                                                </div>
                                            </div>
