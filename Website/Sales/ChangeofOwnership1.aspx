<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ChangeofOwnership1.aspx.cs" Inherits="Customers" %>
    ...
    <div class="info">
        ...
        <div class="collapse in" id="settings" aria-expanded="true" style="">
            <ul class="nav">
                                ...
                                <div class="col-md-8">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="card-title">CHANGE OF OWNERSHIP</div>
                                            ...
                                            <div class="form-group">
                                                <label for="solidInput">Proof of Payment</label>
                                                <asp:TextBox class="form-control input-solid" placeholder="Enter Receipt Number" ID="txtProof" runat="server"></asp:TextBox>
                                            </div>

                                            <asp:Button runat="server" ID="btnSave" class="btn btn-block btn-primary" Text="Update Ownership Details" Font-Bold="true" OnClick="btnSave_Click" />
                                        </div>
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body text-center" style="font-size: 16px; color: #555;">
                                Change of Ownership Done Successfully!
                            </div>
                            <!-- Footer -->
                ...
                <br />
                <asp:Label runat="server" ID="lblSaleAgreementId" Visible="false"></asp:Label>
    </form>
</body>
