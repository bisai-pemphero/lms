<%@ Page Language="C#" AutoEventWireup="true" Async="true" CodeFile="PlotAllocation1.aspx.cs" Inherits="Customers" %>
                                ...
                                <div class="col-md-8">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <label for="solidInput">Contract Duration (Months)</label>
                                                <asp:TextBox class="form-control input-solid" placeholder="Contract Duration" ID="txtDuration" runat="server" TextMode="Number"></asp:TextBox>
                                            ...
                                            <div class="form-group">
                                             ...
                                             <div class="form-group">
     <label for="solidInput">Monthly Installment</label>
     <asp:TextBox class="form-control input-solid" placeholder="Monthly Installment" ID="txtMonthlyInstallment" runat="server" TextMode="Number"></asp:TextBox>
        ...
        <asp:Label runat="server" ID="lblClientName" Visible="false"></asp:Label>
        <br />
        <asp:Label runat="server" ID="lblAdress" Visible="false"></asp:Label>
        <br />
        <asp:Label runat="server" ID="lblEmail" Visible="false"></asp:Label>
        <br />
        <asp:Label runat="server" ID="lblPhone" Visible="false"></asp:Label>
        <asp:Label runat="server" ID="lblSiteName" Visible="false"></asp:Label>
