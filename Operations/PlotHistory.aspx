<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PlotHistory.aspx.cs" Inherits="PlotHistory" %>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <div class="card-title">INNOBUILD PLOT HISTORY</div>
                            </div>
                            ...
                            <div class="col-md-12 row">
                                ...
                                <!-- Back button moved to far right -->
                                <div class="col-md-3 back-button-container">
                                    <div class="form-group">
                                        <asp:Button runat="server" ID="btnBack" Text="Back to Dashboard" CssClass="btn btn-secondary" OnClick="btnBack_Click" />
                                    </div>
                                </div>
                            </div>
            ...
            buttons: [
                {
                    ...
                    title: 'Plot History as of ' + currentDate,
                    exportOptions: {
                        modifier: {
                            search: 'applied',
                            order: 'applied',
                ...
                },
                {
                    ...
                    customize: function (doc) {
                        // Adjust margins for better landscape layout
